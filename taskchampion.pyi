...
class Replica:
    ...
    def get_undo_operations(self) -> Operations | None: ...
...
class Task:
    ...
    def get_uda(self, namespace: str, key: str) -> str | None: ...
    ...
    def set_entry(self, entry: datetime | None, ops: Operations): ...
    def set_wait(self, wait: datetime | None, ops: Operations): ...
    def set_modified(self, modified: datetime, ops: Operations): ...
    def set_value(self, property: str, value: str | None, ops: Operations): ...
    ...
    def set_due(self, due: datetime | None, ops: Operations): ...
